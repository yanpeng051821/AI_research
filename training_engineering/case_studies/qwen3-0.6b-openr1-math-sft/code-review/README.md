...
七个主题的学习文档已准备完成；主题 01 至 07 已通过讲解、代码追踪、独立回答与补测验收。
...
| 05 | [恢复、失败与显存](05_RESUME_FAILURE_AND_MEMORY.md) | 判断能否恢复及如何定位资源问题 | 已完成（2026-09-22） |
| 06 | [评测与证据闭环](06_EVALUATION_AND_EVIDENCE.md) | 复核指标口径、样本配对和结论边界 | 已完成（2026-09-22） |
| 07 | [测试策略与 pytest](07_TESTING_STRATEGY_AND_PYTEST.md) | 能独立设计、运行和诊断本项目的分层测试 | 已完成（2026-09-22） |
